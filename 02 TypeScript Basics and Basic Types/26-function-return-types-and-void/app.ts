...
function printResult(num: number): void {
  console.log('Result: ' + num); // we also can write the void type after the parameter list. we also are not returning anything here. the typescript inference did its job by return this statement to void
}
